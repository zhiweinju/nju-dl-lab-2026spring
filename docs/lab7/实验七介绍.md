...
[下载任务一和任务二代码](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab7/DL2025_lab7_Meta_Learning.ipynb){ .md-button}
...
3. **性能指标**（基线模型 vs MAML在5-way 1-shot任务上的测试准确率）：
    ...
    [下载测试集真实标签](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab7/true_labels.csv){ .md-button}
